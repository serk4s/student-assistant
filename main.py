...
import threading  #напоминание
import datetime  #напоминание и расписание
bot = telebot.TeleBot('6896125004:AAFmm3jzKFvLZCrZNLYduRmjurh87bQUxQ0')

sch = pd.read_excel("расписание.xlsx")
...
def start_and_buttons(message):
    ...
    btn3 = types.KeyboardButton("Напоминание")
...
def func(message):
    if (message.text == "Погода"):
        ...
        bot.send_message(message.chat.id, 'О чем мне тебе напомнить?:')
